...
This code implements a super resolution GAN.

## Model

<a href="https://topmate.io/ajay_shenoy/1615434" style="background-color: #3498db; color: white; padding: 8px 15px; text-decoration: none; font-weight: bold; border-radius: 5px; display: inline-block; font-size: 14px;">Download full code</a>
...
class Generator(nn.Module):
    def __init__(
        ...
        for _ in range(num_rcb):
            trunk.append(ResidualBlock(channels))
...
def srresnet_x2(**kwargs: Any) -> Generator:
    model = Generator(upscale=2, **kwargs)

    return model


def srresnet_x4(**kwargs: Any) -> Generator:
    model = Generator(upscale=4, **kwargs)

    return model


def srresnet_x8(**kwargs: Any) -> Generator:
    model = Generator(upscale=8, **kwargs)

    return model


def discriminator_for_vgg(**kwargs) -> Discriminator:
